...
savePath = "D:\brainNNUNET-210820-7"
...
f = waitbar(0,'Please wait... (TrainingSet)');
% nnUNet json file.
...
parfor iterPatient = 1 : size(dicomPathList, 1)
    ...
    patientLabelSetF = uint8(imresize3(patientLabelSetTemp, [sz_patientLabelSetTemp(1), sz_patientLabelSetTemp(2), sz_patientLabelSetTemp(3).*scalingFactor])); % up-scaling
...
%
f = waitbar(0,'Please wait...(Test set)');
fprintf(fileID,'"test":[');
