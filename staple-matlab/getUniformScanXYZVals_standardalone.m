function [xVals, yVals, zVals] = getUniformScanXYZVals_standardalone(scanStruct)
...
% 2021.06.27 : wjcheon 
sizeArray = size(scanStruct{1})
sizeDim1 = sizeArray(1)-1;
sizeDim2 = sizeArray(2)-1;

scanInfo.xOffset =0; 
scanInfo.yOffset =0;
uniformScanInfo.firstZValue =0;
scanInfo.grid2Units = 0.9765625;
scanInfo.grid1Units = 0.9765625;
uniformScanInfo.sliceThickness = 5.0
...
zVals = uniformScanInfo.firstZValue : uniformScanInfo.sliceThickness : ...
    uniformScanInfo.sliceThickness * (nZSlices-1) + uniformScanInfo.firstZValue;          